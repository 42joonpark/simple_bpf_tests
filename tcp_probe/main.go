...
//go:generate go run github.com/cilium/ebpf/cmd/bpf2go -target bpfel -cc $BPF_CLANG -cflags $BPF_CFLAGS -type event bpf tcp_probe.c -- -I../headers
...
func main() {
	...
	tp, err := link.Tracepoint("tcp", "tcp_probe", objs.TcpProbe)
	if err != nil {
